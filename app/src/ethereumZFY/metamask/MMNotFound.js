...
class MMNotFound extends React.Component {
    state = {}
            ...
            <div className={classes.wrapper}>
                <div className={classes.inner}>
					<header className={classes.header}>
                        ...
                        <p>
                            In order to use the DeHack platform, you need to install and sign in into Metamask extension.
                            After install, refresh this page.
                        </p>
...
export default withStyles(styles)(MMNotFound);
